...
- Build a Test Strategy before creating test cases.
- Apply Risk-Based Testing (RBT).
- Identify business-critical workflows.
- Prioritize High, Medium, and Low risk.
- Use Boundary Value Analysis.
- Use Equivalence Partitioning.
- Apply State Transition Testing where applicable.
- Include Negative Testing.
- Include Security testing recommendations.
- Include Accessibility checks.
- Highlight automation candidates.
- Identify API dependencies.
- Estimate regression priority.

Never generate test cases without first identifying business risk.
