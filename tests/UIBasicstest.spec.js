 ...
 test('@Web Browser Context-Validating Error login', async ({browser})=>
 {
    ...
    // page.route('**/*.{jpg,png,jpeg}',route=> route.abort());
     ...
     await signIn.click();
     //playwrite can wait until the element is visible on the page
 ...
 test.describe('Child windows suite', () => {
    test.describe.configure({ mode: 'only' });
    ...
    const [newPage]= await Promise.all(  // this is a array
   [
      context.waitForEvent('page'),//listen for any new page pending,rejected,fulfilled
      documentLink.click(),
   
   ])//new page is opened in new tab, we can use page.waitForEvent('popup') also
